...
import CityMapSydney from './uiCityMaps/CityMapSydney'
import CityMapNYC from './uiCityMaps/CityMapNYC'
import CityMapTaipei from './uiCityMaps/CityMapTaipei'
import CityMapParis from './uiCityMaps/CityMapParis'
...
const App = () => {
  ...
  const cityHotels = pickWithRandomTotal(
    allCityHotels[city],
    allCityCounts[city]
  )
